...
| [Swiss Parliament Open Data](https://ws.parlament.ch/) / web services | politics and parliamentary activity | web services, structured queries | motions, debates, political signals |
| [Fedlex SPARQL](https://www.fedlex.admin.ch/de/home/sparql.html) | law and regulation | SPARQL endpoint | regulatory change, legal context, amendments |
